...
simmechanics_to_urdf iCubGenova02_SIM_MODEL.xml --output xml --yaml iCubGenova02NoBattery_simmechanics_options.yaml --csv-joints iCubGenova02_joint_parameters.csv --outputfile iCubGenova02NoBattery.urdf
